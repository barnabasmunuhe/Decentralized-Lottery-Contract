...
contract Raffle is VRFConsumerBaseV2Plus {
    ...
    constructor(uint256 entranceFee, uint256 interval, address _vrfCoordinator, uint64 subscriptionId, bytes32 gasLane)
    ...
    /**
     * @notice Callback function used by Chainlink VRF to return random words.
